...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ assets('frontend/assets/images/favicon.png')}}">
    <!-- Custom CSS -->
    <link href="{{ assets('frontend/assets/libs/chartist/dist/chartist.min.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{ assets('frontend/dist/css/style.min.css')}}" rel="stylesheet">
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ assets('frontend/assets/images/logo-icon.png')}}" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="{{ assets('frontend/assets/images/logo-light-icon.png')}}" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{ assets('frontend/assets/images/logo-text.png')}}" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                            <img src="{{ assets('frontend/assets/images/logo-light-text.png')}}" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{ assets('frontend/assets/images/users/1.jpg')}}" alt="user" class="rounded-circle" width="31">
                            </a>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                <div class="user-pic"><img src="{{ assets('frontend/assets/images/users/1.jpg')}}" alt="users"
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2"><img src="{{ assets('frontend/assets/images/users/1.jpg')}}" alt="user" width="50"
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="{{ assets('frontend/assets/images/users/4.jpg')}}" alt="user" width="50"
                                            class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="{{ assets('frontend/assets/images/users/5.jpg')}}" alt="user" width="50"
                                            class="rounded-circle"></div>
                                    <div class="comment-text w-100">
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{ assets('frontend/assets/libs/jquery/dist/jquery.min.js')}}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{ assets('frontend/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{ assets('frontend/dist/js/app-style-switcher.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{ assets('frontend/dist/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{ assets('frontend/dist/js/sidebarmenu.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{ assets('frontend/dist/js/custom.js')}}"></script>
    <!--This page JavaScript -->
    <!--chartis chart-->
    <script src="{{ assets('frontend/assets/libs/chartist/dist/chartist.min.js')}}"></script>
    <script src="{{ assets('frontend/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js')}}"></script>
    <script src="{{ assets('frontend/dist/js/pages/dashboards/dashboard1.js')}}"></script>
</body>
